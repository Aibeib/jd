        ...
        <div class="personMessage clean">
            ...
            <div class="myoperate">
                <van-grid :border="false" >
                    ...
                    <van-grid-item icon="send-gift-o" text="待收货" @click="tobereceived"/>
                    <van-grid-item icon="cash-on-deliver" text="售后/退换"  />
                    <van-grid-item icon="balance-list-o" color="#FFA500" text="全部订单" @click="allorder" />
                </van-grid>
            </div>
        </div>
        <div class="content">
        ...
        <!-- 工具与服务 -->
             <div class="tool">
                 ...
                 <div class="tool-list">
                    ...
                    <div class="service" v-for="item in imglist" :key="item.id" @click="toPath(item.path)">
...
export default {
    ...
    data() {
        return {
            mylist:[{title:'商品收藏',num:0,id:101},{title:'店铺收藏',num:1,id:102},{title:'我的足迹',num:8,id:103}],
            imglist:[
                {url:'http://img12.360buyimg.com/img/s70x70_jfs/t1/135809/4/7014/5528/5f35369dE8aff3fab/f4b952a87ea33ae4.png.webp',title:'客户服务',path:'',id:1},
                {url:'https://img12.360buyimg.com/img/s70x70_jfs/t1/143427/38/5400/4413/5f350384Edba4458b/bfcb210d2110a7d8.png.webp',title:'我的预约',path:'',id:2},
                {url:'https://img12.360buyimg.com/img/s70x70_jfs/t1/138657/15/5351/5178/5f3504ceE3707cfd0/bc8ff48c8edcc5b1.png.webp',title:'我的问答',path:'',id:3},
                {url:'https://img12.360buyimg.com/img/s70x70_jfs/t1/112188/32/14787/4956/5f3509edE376c2ddb/d716c6822cafa2b6.png.webp',title:'闲置换钱',path:'',id:4},
...
.recomm_mod_title .recomm_mod_title_text:after, .recomm_mod_title .recomm_mod_title_text:before {
    content: "";
    position: absolute;
    top: 50%;
    margin-top: -2px;
